...
logging.config.fileConfig(fname='../config/ui_log.conf', disable_existing_loggers=False)
...
class Env():
    def __init__(self, env):
        ...
        if env == 'Paper':
            try:
                #self.key_id = os.environ['PAPI_KEY']
                self.key_id = PAPI_KEY
                #self.secret_key = os.environ['PAPI_SECRET']
                self.secret_key = PAPI_SECRET
                #self.base_url = os.environ['PBASE_URL']
                self.base_url = PBASE_URL
            except Exception as e:
        ...
        if env == 'Live':
            try:
                #self.key_id = os.environ['API_KEY']
                self.key_id = API_KEY
                #self.secret_key = os.environ['API_SECRET']
